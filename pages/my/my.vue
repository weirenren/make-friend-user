<template>
	<view>
		...
		<view class="block-wrap">
			...
			<u-grid :col="4" :border="false" style="margin: 10rpx 0;" @click="toNav">
		...
		<view class="by">
			<text class="by-text">@2022 后厂花开</text>		
			<view>
				<a href="https://beian.miit.gov.cn/" target="_blank" class="by-text">京ICP备20013503号-1</a>
			</view>
		</view>
		<!-- tabbar -->
...
<script>
	export default {
		...
		methods: {
			toLoveLikeResult() {
				uni.navigateTo({
					url: '/pages/user/love/love-match-result'
				});
			},
			getUserMenu() {
