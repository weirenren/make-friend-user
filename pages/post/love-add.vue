<template>
	<view class="container">
		...
		<textarea placeholder="详细内容" :auto-height="true" maxlength="-1" v-model="form.content" class="post-txt"></textarea>
		...
		<!-- 	<u-upload
				...
				:auto-upload="false"
			></u-upload> -->
			<cl-upload ref="uUpload" @input="onFileChange" @onFileChange="onFileChange" :imageFormData="imageFormData" :isPreviewImage="true" fileType="image" :action="uploadImgUrl" :autoUpload="false" >
		...
		<!-- 选择话题 -->
		<navigator v-if="showView&&form.topicId" :url="'/pages/choose-discuss/choose-discuss?topicId=' + form.topicId" class="choose-item">
...
export default {
	...
	methods: {
		...
		submitPost(medias) {
			...
			this.form.content = JSON.stringify(loveJsonRequestor.createCommonPost('beijing', this.general_info_gender, this.form.title, this.form.content))
