		...
		<view class="con-c">
			<view class="user-info">
				...
				<view class="user-c">
					...
					<view class="btn-box u-skeleton-fillet" v-if="currUid!=uid">
						<u-button v-show="!userInfo.isFollow" @click="follow" :custom-style="btnStyle" class="btn"
							shape="circle" size="mini">
							<u-icon name="plus"></u-icon>
							<text>关注</text>
						</u-button>
						<u-button v-show="userInfo.isFollow" @click="cancelFollow" :custom-style="btnStyle2"
			...
			<view v-show="current === 0">
				...
				<!-- 创建的圈子 -->
				<view v-if="userInfo.createTopicList.length > 0" class="f-wrap u-skeleton-fillet">
	...
	export default {
		...
		data() {
			return {
				...
				btnStyle: {
					color: "#fff",
					backgroundColor: '#59aef2'
				},
				btnStyle2: {
					border: '1px solid #59aef2',
					color: "#59aef2"
				},
				background: {
